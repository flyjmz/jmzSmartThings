...
metadata {
	...
	tiles {
		standardTile("contact", "device.contact", width: 2, height: 2, canChangeBackground: true) {
			state "open", label: 'stepped on', icon: "https://raw.githubusercontent.com/flyjmz/jmzSmartThings/master/resources/matSteppedOn.jpg", backgroundColor: "#79b821"   
			state "closed", label: 'empty', icon: "https://raw.githubusercontent.com/flyjmz/jmzSmartThings/master/resources/mat.jpg", backgroundColor: "#ffa81e"	
