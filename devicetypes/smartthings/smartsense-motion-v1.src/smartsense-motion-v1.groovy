 ...
 */
metadata {
	definition (name: "SmartSense Motion v1", namespace: "smartthings", author: "SmartThings") {  	//flyjmz changed name of app to clarify this is for the original Smartthings Motion
		capability "Signal Strength"
		capability "Motion Sensor"
		capability "Sensor"
		capability "Battery"
        capability "Power Source"   //flyjmz added for display on SmartThings API in My Devices.
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"motion", type: "generic", width: 6, height: 4){
            ...
            tileAttribute ("device.powerSource", key: "SECONDARY_CONTROL"){		//flyjmz added, shows power source on device's page in app
            	attributeState "battery", label:'Battery Power'
            	attributeState "powered", label:'AC Power'
            }
		}
