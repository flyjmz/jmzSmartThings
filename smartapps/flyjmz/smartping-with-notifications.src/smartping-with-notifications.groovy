...
preferences {
	page(name: "setup", title: "SmartPing with Notifications", install: false, uninstall: true, submitOnChange: true) {
    		section("") {
            		app(name: "SmartPing with Notifications", appName: "SmartPing Automation and Notification", namespace: "flyjmz", title: "Add website", multiple: true)
		}
	}
}
