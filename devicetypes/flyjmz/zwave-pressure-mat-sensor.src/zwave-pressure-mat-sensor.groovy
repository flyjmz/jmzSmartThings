 ...
 *  
 *	Updated from @kewashi
 *
 *  Date: 2013-11-3
 *	Updated 2017-04-10, added custom icon and flipped open/closed so that Open = stepped on (most smartapps treat open sensors as 'bad' so this will now act the same way)
 */

// for the UI
metadata {
	// Automatically generated. Make future change here.
	definition (name: "Z-Wave Pressure Mat Sensor", namespace: "flyjmz", author: "flyjmz230@gmail.com") {
