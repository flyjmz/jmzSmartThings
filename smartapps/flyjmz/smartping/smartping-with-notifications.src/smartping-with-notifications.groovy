...
definition(
	name: "SmartPing with Notifications",
...
preferences {
	page(name: "setup", title: "SmartPing with Notifications", install: true, uninstall: true, submitOnChange: true) {
    		section("") {
            		app(name: "SmartPing's Automations and Notifications", appName: "SmartPing's Automations and Notifications", namespace: "flyjmz/SmartPing", title: "Add website", multiple: true)
		}
	}
}
